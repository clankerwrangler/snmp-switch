...
WRITABLE = {'dot1qVlanForbiddenEgressPorts', 'dot1qVlanStaticName', 'ifAdminStatus', 'dot1qVlanStaticUntaggedPorts', 'dot1qVlanStaticEgressPorts', 'dot1qVlanStaticRowStatus', 'dot1qPvid'}
rows = []
def add(module,name,oid,syntax,idx,source,formal='outside-core',access='read-only'):
    refs={'SNMPv2-MIB':'RFC3418','IF-MIB':'RFC2863','BRIDGE-MIB':'RFC4188','Q-BRIDGE-MIB':'RFC4363','ENTITY-MIB':'RFC6933'}
